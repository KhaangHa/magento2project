...
define([
    ...
    return Collection.extend({
        defaults: {
            ...
            defaultIndex: 'Packt.HelloWorld.view.frontend.layout.default',
            activeIndex: 'Packt.HelloWorld.view.frontend.layout.default',
            viewsArray: [],
            storageConfig: {
            ...
            views: {
                default: {
                    ...
                    index: 'Packt.HelloWorld.view.frontend.layout.default',
                    editable: false
                }
            },
            tracks: {
