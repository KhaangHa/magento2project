...
namespace Magenest\Affiliate\Block\Adminhtml\System\Config\Fieldset;
...
class Version extends Template implements RendererInterface
{
    ...
    public function getVersion()
    {
        ...
        $composer = $this->getComposerInformation("Magenest_Affiliate");
    ...
    {
        return 'Magenest_Affiliate::system/config/fieldset/version.phtml';
    }
}
