		...
		init : function(ed, url) {
			...
			function buildFormats(str) {
				...
				each(str.split(/,/), function(type) {
					formats.push({
						title : 'advlist.' + (type == 'Packt.HelloWorld.view.frontend.layout.default' ? 'def' : type.replace(/-/g, '_')),
						styles : {
							listStyleType : type == 'Packt.HelloWorld.view.frontend.layout.default' ? '' : type
						}
					});
				});
